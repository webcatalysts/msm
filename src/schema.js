...
SchemaUtil.projectSchema = function (project, schema) {
  var removeFields = [];
  var includeFields = [];
...
SchemaUtil.projectSchemaRecurse = function (schema, includeFields, removeFields, ns) {
  var result = {};
...
SchemaUtil.fieldIsIncludedInProject = function (project, field_name) {
...
SchemaUtil.flattenSchemaFields = function (schema, ns) {
  var result = {};
  for (var f in schema) {
    var v = schema[f];
    if (ns) {
...
SchemaUtil.flattenResults = function (results) {
    var ret = [];
...
SchemaUtil.flattenResult = function (result, ns = null) {
    var ret = {}
...
SchemaUtil.expandSchema = function (fields) {
...
SchemaUtil.mergeSchema = function (a,b) {
...
SchemaUtil.setNestedValue = function (obj, parents, value, force = false) {
    var schema = obj;
...
SchemaUtil.analyzeSchema = function (con, dbName, colName, options) {
...
SchemaUtil.schemaAnalysisBuildCode = function (colName, options) {
...
SchemaUtil.extractSchema = function (con, dbName, colName) {
...
SchemaUtil.buildSchemaFromFields = function(fields) {
    var fieldNames = [];
    var schema = {};
...
SchemaUtil.sortSchema = function (schemaIn) {
    var schemaOut = {};
    var fields = [];
